...
const NAV: { id: Page; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { id: "packages", label: "包管理器", icon: Package },
...
export function Sidebar() {
  ...
  return (
    <aside className="w-16 md:w-52 shrink-0 flex flex-col border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
      {/* Logo */}
      ...
      <div className="hidden md:block px-4 py-3 text-[10px] text-zinc-400 dark:text-zinc-600 border-t border-zinc-100 dark:border-zinc-800">
        v{APP_VERSION} · 便携模式就绪
      </div>
    </aside>
  );
}
